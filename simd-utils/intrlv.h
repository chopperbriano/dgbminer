...
#include <immintrin.h> // AVX and newer intrinsics if needed
#include <stdint.h> // For uint32_t

//// Function to cast and load __m128i
//__m128i casti_m128i(uint32_t* ptr, int i) {
//    return _mm_load_si128((__m128i*)(ptr + i * 4)); // Assuming ptr is 32-byte aligned
//}
...
static void extr_lane_4x32( void *d, const void *s,
                                   const int lane, const int bit_len )
{
...
static void mm128_bswap32_80( void *d, void *s )
{
...
{
  __m128i s0 = casti_m128i((uint32_t*)src,0 );
  __m128i s1 = casti_m128i((uint32_t*)src,1 );
  __m128i s2 = casti_m128i((uint32_t*)src,2 );
  __m128i s3 = casti_m128i((uint32_t*)src,3 );
  __m128i s4 = casti_m128i((uint32_t*)src,4 );
  ...
  casti_m128i((uint32_t*)d, 0 ) = _mm_shuffle_epi32( s0, 0x00 );
  casti_m128i((uint32_t*)d, 1 ) = _mm_shuffle_epi32( s0, 0x55 );
  casti_m128i((uint32_t*)d, 2 ) = _mm_shuffle_epi32( s0, 0xaa );
  casti_m128i((uint32_t*)d, 3 ) = _mm_shuffle_epi32( s0, 0xff );

  casti_m128i((uint32_t*)d, 4 ) = _mm_shuffle_epi32( s1, 0x00 );
  casti_m128i((uint32_t*)d, 5 ) = _mm_shuffle_epi32( s1, 0x55 );
  casti_m128i((uint32_t*)d, 6 ) = _mm_shuffle_epi32( s1, 0xaa );
  casti_m128i((uint32_t*)d, 7 ) = _mm_shuffle_epi32( s1, 0xff );

  casti_m128i((uint32_t*)d, 8 ) = _mm_shuffle_epi32( s2, 0x00 );
  casti_m128i((uint32_t*)d, 9 ) = _mm_shuffle_epi32( s2, 0x55 );
  casti_m128i((uint32_t*)d,10 ) = _mm_shuffle_epi32( s2, 0xaa );
  casti_m128i((uint32_t*)d,11 ) = _mm_shuffle_epi32( s2, 0xff );

  casti_m128i((uint32_t*)d,12 ) = _mm_shuffle_epi32( s3, 0x00 );
  casti_m128i((uint32_t*)d,13 ) = _mm_shuffle_epi32( s3, 0x55 );
  casti_m128i((uint32_t*)d,14 ) = _mm_shuffle_epi32( s3, 0xaa );
  casti_m128i((uint32_t*)d,15 ) = _mm_shuffle_epi32( s3, 0xff );

  casti_m128i((uint32_t*)d,16 ) = _mm_shuffle_epi32( s4, 0x00 );
  casti_m128i((uint32_t*)d,17 ) = _mm_shuffle_epi32( s4, 0x55 );
  casti_m128i((uint32_t*)d,18 ) = _mm_shuffle_epi32( s4, 0xaa );
  casti_m128i((uint32_t*)d,19 ) = _mm_shuffle_epi32( s4, 0xff );
}
