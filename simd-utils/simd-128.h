...
#else
//   asm( "pcmpeqq %0, %0\n\t" : "=x"(a) );
    g_a = _mm_setzero_si128();
    g_a = _mm_cmpeq_epi64(g_a, g_a);
...
static __m128i mm128_bswap_64( __m128i v )
{
...
static __m128i mm128_bswap_32( __m128i v )
{
      v = _mm_or_si128( _mm_slli_epi16( v, 8 ), _mm_srli_epi16( v, 8 ) );
...
static __m128i mm128_bswap_16( __m128i v )
{
...
static void mm128_block_bswap_64( __m128i *d, const __m128i *s )
{
