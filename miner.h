...
__declspec(align(64)) struct work
{
    __declspec(align(64)) uint32_t target[8]/* __attribute__ ((aligned (64)))*/;
    __declspec(align(64)) uint32_t data[48] /*__attribute__ ((aligned (64)))*/;
	double targetdiff;
	double sharediff;
   double stratum_diff;
	int height;
...
__declspec(align(64)) struct stratum_job
{
...
__declspec(align(64)) struct stratum_ctx {
	char *url;
    ...
    __declspec(align(64)) struct work work /*__attribute__ ((aligned (64)))*/;
